...
interface AuthModalProps {
  ...
  onAuthSuccess?: (user: any) => void; // optional
}

const API_BASE = "http://localhost:4000/api"; // chỉnh lại nếu khác
...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  // reset form & error mỗi lần mở / đổi mode
  useEffect(() => {
    if (isOpen) {
      ...
      >
        ...
        <div className="p-8 pt-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Username: DÙNG CHUNG cho login & register */}
            <Input
              label="Username"
            ...
            {/* Email: chỉ hiển thị khi register, tạm chưa gửi lên BE */}
            {mode === "register" && (
              <Input
                label="Email Address"
                type="email"
